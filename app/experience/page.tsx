                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-col space-y-2">
                            ...
                            <div className="flex items-center justify-center pt-3">
                              <div className={`w-2 h-2 border-t-2 border-r-2 border-zinc-400 transition-all duration-500 ease-in-out ${expandedCards.has(exp.title) ? '-rotate-45 scale-110' : 'rotate-45 scale-100'
                                }`}></div>
                            </div>
                          </div>
                        </div>
