	...
	useEffect(() => {
		const calculateHeights = () => {
			...
			experience.forEach((exp) => {
				const contentRef = contentRefs.current[exp.title];
				if (contentRef) {
					// Use scrollHeight for more accurate measurement of full content
					heights[exp.title] = contentRef.scrollHeight;
				}
			});
			setCardHeights(heights);
		...
		// Add a longer delay to ensure DOM is fully rendered with list items
			...
			<div className="px-6 pt-20 mx-auto space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-24 lg:pt-32 pb-16">
				<div className="max-w-2xl mx-auto lg:mx-0">
					...
					<p className="mt-4 text-zinc-400">
						My professional journey in software development and blockchain
						engineering.
					</p>
				</div>
				...
				<div className="relative">
					{/* Timeline line */}
					<div className="absolute left-8 top-0 bottom-0 w-0.5 bg-zinc-700/50" />

					<div className="space-y-8">
						{experience.map((exp, index) => (
							<div key={exp.title} className="relative">
								{/* Timeline dot */}
								<div className="absolute left-6 top-1/2 transform -translate-y-1/2 w-4 h-4 bg-blue-800 rounded-full border-4 border-zinc-900 z-10" />
												...
												<div className="flex-1 min-w-0">
													<div className="flex flex-col space-y-2">
														...
														>
															...
															>
																<ul className="text-sm text-zinc-300 leading-relaxed select-none font-medium group-hover:text-zinc-200 transition-colors duration-300 list-disc list-inside space-y-2">
														...
														<div className="flex items-center justify-center pt-3">
															<div
																className={`w-2 h-2 border-t-2 border-r-2 border-zinc-400 transition-all duration-500 ease-in-out ${
